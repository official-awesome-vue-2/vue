---
title: UI Components
description: Explore a range of Vue.js data table and grid components, offering features like sorting, filtering, pagination, and responsive design to enhance your data presentation.
...
- [vue-teible](https://github.com/hiendv/teible) - Lightweight and flexible table component for the web
...
- [toast-ui.vue-grid](https://github.com/nhnent/toast-ui.vue-grid) - Vue Wrapper for [TOAST UI Grid](https://ui.toast.com/tui-grid/).
...
- [vue3-progress](https://github.com/marcoschulte/vue3-progress) - Fully customizable Vue 3 plugin to display a progress bar while waiting for something, e.g. HTTP requests
...
- [vue-icons](https://github.com/kalimah-apps/vue-icons) - More than 11,000 icons from most popular icon libraries (Bootstrap, Font Awesome, Feather .. etc)
...
- [vue-split-carousel](https://github.com/Aaron00101010/vue-split-carousel) - A carousel component meanwhile display several carousel item, supports Vue 2 and Vue 3
...
- [vue2vis](https://github.com/alexcode/vue2vis) - Vue2 wrapper for [Visjs](https://visjs.org/).
...
- [toast-ui.vue-chart](https://github.com/nhnent/toast-ui.vue-chart) - Vue Wrapper for [TOAST UI Chart](https://ui.toast.com/tui-chart/).
...
- [bs-vue-timeline](https://github.com/x10sv/bs-vue-timeline) - An alternative responsive bootstrap-vue timeline
...
- [toast-ui.vue-calendar](https://github.com/nhnent/toast-ui.vue-calendar) - Vue Wrapper for [TOAST UI Calendar](https://ui.toast.com/tui-calendar).
...
- [vue-maplibre-gl](https://github.com/razorness/vue-maplibre-gl) - Vue 3.x wrapper around Maplibre GL JS library written in TypeScript. Including style switch and frame rate control
...
- [1llest-waveform-vue](https://github.com/codeacme17/1llest-waveform-vue) - A lightweight and controllable audio visualization Vue 3 plugin
...
- [vue-dynamic-star-rating](https://github.com/JonathanDn/vue-stars-rating) - A highly dynamic vue stars rating component, like google play rating
...
- [vue-star-rating](https://github.com/craigh411/vue-star-rating) - A simple, highly customizable star rating component
...
- [vue-phone-number-input](https://github.com/LouisMazel/vue-phone-number-input) - A beautiful input to format & valid phone number with country code
...
- [vue2-timepicker](https://github.com/phoenixwong/vue2-timepicker) - A dropdown time picker (hour|minute|second) for Vue 2.x, with flexible time format support. (Back and recharged in 2019)
...
- [vue3-dnd](https://github.com/hcg1023/vue3-dnd) - React DnD in composition API implementation, Use the composition API for sortable and free draggable, Supported Vue 2, Vue 3
...
- [vue-cleave-component](https://github.com/ankurk91/vue-cleave-component) - Vue.js component for [cleave.js](https://nosir.github.io/cleave.js/)
...
- [vue-trumbowyg](https://github.com/ankurk91/vue-trumbowyg) - Vue.js component for [Trumbowyg](https://alex-d.github.io/Trumbowyg/) WYSIWYG editor
...
- [vue-submit](https://github.com/NxtChg/pieces/tree/master/js/vue/vue-submit) - Simple implementation of Ladda ([1](https://lab.hakim.se/ladda/), [2](https://msurguy.github.io/ladda-bootstrap/)) in less than 90 lines of code with no dependencies.
...
- [vue3-form-wizard](https://github.com/parsajiravand/vue3-form-wizard) - Vue3-form-wizard is a Vue based component with no extsernal depenendcies which simplifies tab wizard management
...
- [vue-easeljs](https://github.com/dankuck/vue-easeljs) - Data-driven control over an HTML5 canvas element.
